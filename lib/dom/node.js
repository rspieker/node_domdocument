...
Node.prototype.___property = function()
{
	return helper.combine({
		...
		namespaceURI: {
			get: function(){
				return 'prop' in this && 'nsURI' in this.prop ? this.prop.nsURI : null;
			}
		},
		...
		prefix: {
			...
			//  TODO: implement Node.prefix as part of the namespaces
		},
		...
		localName: {
			get: function(){
				//  TODO: implement Node.localName as part of the namespaces
...
Node.prototype.insertBefore = function(newChild, refChild)
{
	...
	//  not every node has a parent, it may have become unattached of it may have never been attached
	if (newSimple.parent)
...
Node.prototype.isEqualNode = function(arg)
{
	...
	if (typeof this.attributes === typeof arg.attributes && this.attributes instanceof NamedNodeMap)
		for (i = 0; i < this.attributes.length; ++i)
		{
			attr = this.attributes.item(i);
			if (!arg.hasAttribute(attr.nodeName) || attr.nodeValue !== arg.getAttribute(attr.nodeName))
				return false;
		}
	...
	for (i = 0; i < this.childNodes.length; ++i)
		if (!arg.childNodes[i] || !this.childNodes[i].isEqualNode(arg.childNodes[i]))
			return false;
